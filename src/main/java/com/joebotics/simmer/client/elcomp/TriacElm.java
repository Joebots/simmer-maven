...
import com.jobotics.simmer.client.util.Diode;
...
// FIXME need to uncomment TriacElm line from Simmer.java
...
public class TriacElm extends AbstractCircuitElement {
	final int anode = 0;
	double aresistance;
	Point cathode[], gate[];
	final int cnode = 1;
