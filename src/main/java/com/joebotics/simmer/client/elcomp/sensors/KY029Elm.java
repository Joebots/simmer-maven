 ...
 */
public class KY029Elm extends ChipElm {

    public KY029Elm(int xx, int yy) {
        super(xx, yy);
        footprintName = "SIP3";
    }

    public KY029Elm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
    ...
    protected Color getLEDColor() {
        ...
        double weight = 255;
        return new Color((int) (redVoltage/summaryVoltage * weight), (int) (greenVoltage/summaryVoltage * weight), 0);
    }
}
